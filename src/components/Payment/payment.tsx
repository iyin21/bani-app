...
const Payment=({handlePayment}:{handlePayment:()=> void})=>{
        ...
        <div className="bg-white px-[16px] pt-[36px] pb-[24px]">
            ...
            <div className="flex justify-between">
                ...
                <div className="flex">
                    ...
                    <Input name="quantity" type={"number"} className="w-10 md:px-2  mx-2 h-8" onChange={(e)=>dispatch(setPaymentData({...payment,quantity: e.target.value}))}/>
